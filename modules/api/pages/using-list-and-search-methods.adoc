...
Search uses a "like-based" algorithm for searching, and finds matches where the search string occurs anywhere in a phrase or a word. As of 2023.2, "Word-based" and “Start with” search algorithms cannot be configured anymore as they are obsolete.”
